...
await conn.sendImageAsSticker(m.chat, urls, m, { packname: global.packname, author: global.author })
}
handler.customPrefix = /^(hu|huu|huuu|huuuu|huuuuu|ok|oke|ook|okee|okk|nice)$/i
